...
///
/// This is the serializer that backs [`serde_encom::to_value`][crate::to_value].
/// Unlike the main serde_encom serializer which goes from some serializable
/// value of type `T` to EnCom text, this one goes from `T` to
/// `serde_encom::Value`.
///
...
/// ```
/// use serde::Serialize;
/// use serde_encom::{Error, Value};
///
/// pub fn to_value<T>(input: T) -> Result<Value, Error>
/// where
///     T: Serialize,
/// {
///     input.serialize(serde_encom::Serializer)
/// }
/// ```
